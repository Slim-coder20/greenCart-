    ...
    <div className="flex flex-col items-center justify-center text-center space-y-2 mt-24 pb-14">
      ...
      >
        ...
        <div className="max-w-96 w-full px-4">
          ...
          <div className="mb-4">
            <label htmlFor="message" className="font-medium text-primary">
              Message
            </label>
            <textarea
              rows="4"
          ...
          <button
            type="submit"
            className="flex items-center justify-center gap-1 mt-5 bg-primary hover:bg-primary-dull text-white py-2.5 w-full rounded-full transition"
          >
            Submit Form
            <svg
              className="mt-0.5"
